    ...
    <div class="grid-2col">
      ...
      <div class="menu-card">
        ...
        <div class="service-list">
          ...
          <div class="service-item"><span class="service-name">Treatment w/ Cooling Contour Mask</span><span class="service-dots"></span><span class="service-price">₹6,000</span></div>
  ...
  <div class="content-body" style="gap: 2mm;">
    <div class="grid-2col" style="gap: 3.5mm;">
      ...
      <div class="menu-card" style="padding: 2.8mm 3.5mm;">
        ...
        <div class="service-list">
          <div class="service-item"><span class="service-name">Arms Polishing</span><span class="service-dots"></span><span class="service-price">₹1,500</span></div>
          ...
          <div class="service-item"><span class="service-name">Full Body Polishing</span><span class="service-dots"></span><span class="service-price">₹4,000</span></div>
        </div>
      </div>
    </div>
