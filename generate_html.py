  ...
  <div class="content-body" style="gap: 2mm;">
    <div class="grid-2col" style="gap: 3.5mm;">
      ...
      <div class="menu-card" style="padding: 2.8mm 3.5mm;">
        ...
        <div class="section-label">Skin, Hand & Feet</div>
        <div class="service-list">
          <div class="service-item"><span class="service-name">Manicure</span><span class="service-dots"></span><span class="service-price">₹600</span></div>
          <div class="service-item"><span class="service-name">French Manicure</span><span class="service-dots"></span><span class="service-price">₹700</span></div>
          <div class="service-item"><span class="service-name">Pedicure</span><span class="service-dots"></span><span class="service-price">₹700</span></div>
          <div class="service-item"><span class="service-name">French Pedicure</span><span class="service-dots"></span><span class="service-price">₹800</span></div>
        ...
        <div class="section-label">Spa — Hand & Feet</div>
        <div class="service-list">
          <div class="service-item"><span class="service-name">Spa Manicure</span><span class="service-dots"></span><span class="service-price">₹1,000</span></div>
          <div class="service-item"><span class="service-name">Spa Pedicure</span><span class="service-dots"></span><span class="service-price">₹1,000</span></div>
        </div>

        <div class="section-label">Luxury Hand & Feet</div>
        <div class="service-list">
          <div class="service-item"><span class="service-name">Luxury Manicure</span><span class="service-dots"></span><span class="service-price">₹1,500</span></div>
          <div class="service-item"><span class="service-name">Luxury Pedicure</span><span class="service-dots"></span><span class="service-price">₹1,500</span></div>
        </div>
    ...
    <div class="patna-footer-card">
      ...
      <div class="pfc-right-qr">
        <!-- 1st QR CODE: PDF REDIRECT -->
        <div class="qr-box">
          <img src="qr_pdf.png" class="qr-img" alt="PDF Menu QR">
          <span class="qr-label">PDF MENU</span>
          <span class="qr-sub">Scan to Download</span>
        </div>

        <!-- 2nd QR CODE: HTML REDIRECT -->
        <div class="qr-box">
          <img src="qr_html.png" class="qr-img" alt="Web Menu QR">
          <span class="qr-label">WEB MENU</span>
          <span class="qr-sub">Scan for Interactive</span>
        </div>
      </div>
    </div>
  </div>
